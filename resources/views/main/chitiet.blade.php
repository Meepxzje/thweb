...
<head>
    ...
    <link href="{{asset('admin/bot/css')}}/thuan.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">VM ADMIN</div>
            </a>
            ...
            <li class="index-slider--nav">
                <div class="sidebar-menu">
                    <nav class="megamenu-nav">
                        <ul class="megamenu-nav-main">
                            <li>
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h4 mb-0 text-gray-800 mr-auto">Danh Mục</h1>
                                </div>
                            </li>
                            <li class="megamenu-item mg-1">
                                ...
                                <div class="megamenu-content absolute-center level0 xlab_grid_container" style="display: none;">
                                    <div class="column xlab_column_5_5">
                                        <div class="sub-megamenu-item smg-1">
                                            <a class="sub-megamenu-item-name" href="/pages/laptop-van-phong">Thương hiệu</a>
                                            @foreach($NhaSanXuat1 as $nsx)
                                            <a class="sub-megamenu-item-filter" href="{{ route('index.chitiet', ['id' => $nsx->IDNSX]) }}">
                                                {{ $nsx->TenNSX ?? 'Không xác định' }}
                                            </a>
                                            @endforeach
                                        ...
                                        <div class="sub-megamenu-item smg-2">
                                            <a class="sub-megamenu-item-name" href="">Giá bán</a>
                                            <a class="sub-megamenu-item-filter" href="r">Dưới 15 triệu</a>
                                            <a class="sub-megamenu-item-filter" href="">Từ 15 đến 20 triệu</a>
                                            <a class="sub-megamenu-item-filter" href="">Trên 20 triệu</a>
                                        </div>
                            ...
                            <li class="megamenu-item mg-4">
                                <a class="megamenu-link" href="#">
                                    <span class="megamenu-icon" data-hover="ssd-ram-hdd-the-nho"><svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="megamenu-name">SSD - RAM - HDD</span>
                                    <span class="megamenu-ic-right">
                                        <svg viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.5 1.5L4.5 4L1.5 6.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                            ...
                            <li class="megamenu-item mg-5">
                                <a class="megamenu-link" href="/collections/macbook">
                                    <span class="megamenu-icon" data-hover="apple"><svg width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="megamenu-name">Apple</span>
                                    <span class="megamenu-ic-right">
                                        <svg viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.5 1.5L4.5 4L1.5 6.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 mr-auto">Tất cả Sản Phẩm
            </h1>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div>
                            <img style="width: 5rem;" src="{{asset('img\nsx')}}\{{$sp->imgNSX}}" alt="img">
                        </div>
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="{{asset('img\sp')}}\{{$sp->imgSP}}" alt="img">
                        </div>
                        <div>Tên Sản Phẩm: {{$sp->TenSP}}</div>
                        <br>
                        <div> Mô Tả: {{$sp->MoTa}}</div>
                        <br>
                        <div>Loại sản phẩm: {{$sp->TenLSP}}</div>
                        <br>
                        <div style="text-align: center;"><h4 style="color:red;">Giá: {{$sp->Gia}}</h4></div>
                    </div>
