                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $ncc->TenNCC }}</td>
                            <td>
                                <a href="{{ route('ncc.suancc', ['id' => $ncc->IDNCC]) }}" class="btn btn-warning">Sửa</a>
                                <a href="{{ route('ncc.xoancc', ['id' => $ncc->IDNCC]) }}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Xóa</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
