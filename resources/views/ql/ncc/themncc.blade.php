...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('ncc.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="ma-ncc" class="form-label">ID NCC:</label>
                            <input type="text" class="form-control form-control-sm" style="width: 500px;" id="idncc" name="idncc" required>
                        </div>

                    </div>
                    <div class="mb-3">
                        <label for="tenncc" class="form-label">Tên NCC:</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="tenncc" name="tenncc" required>
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm">Thêm NCC</button>
                </form>
            </div>
