    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Sửa Nhà Cung Cấp</h1>

            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('ncc.update', ['id' => $ncc->IDNCC]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="idncc" class="form-label">ID NCC:</label>
                        <input type="text" class="form-control" style="width: 500px;" id="idncc" name="idncc" value="{{ $ncc->IDNCC }}" readonly>
                    </div>

                    <div class="mb-3">
                        <label for="tenncc" class="form-label">Tên NCC:</label>
                        <input type="text" class="form-control" style="width: 500px;" id="tenncc" name="tenncc" value="{{ $ncc->TenNCC }}">
                    </div>
