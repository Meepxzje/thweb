...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sp.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="ma-sp" class="form-label">ID Sản Phẩm:</label>
                            <input type="text" class="form-control form-control-sm" style="width: 500px;" id="idsp" name="idsp" required>
                        </div>

                    </div>
                    <div class="mb-3">
                        <label for="tensp" class="form-label">Tên Sản Phẩm:</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="tensp" name="tensp" required>
                    </div>
                    <div class="mb-3">
                        <label for="tensp" class="form-label">Giá:</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="gia" name="gia" required>
                    </div>
                    <div class="mb-3">
                        <label for="tensp" class="form-label">Mô Tả</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="mota" name="mota" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Thêm SP</button>
                </form>
            </div>
