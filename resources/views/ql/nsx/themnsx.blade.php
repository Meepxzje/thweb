...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('nsx.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="ma-nsx" class="form-label">ID NSX:</label>
                            <input type="text" class="form-control form-control-sm" style="width: 500px;" id="idnsx" name="idnsx" required>
                        </div>

                    </div>
                    <div class="mb-3">
                        <label for="tennsx" class="form-label">Tên NSX:</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="tennsx" name="tennsx" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Thêm NSX</button>
                </form>
            </div>
