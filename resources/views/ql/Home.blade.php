    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800 mr-auto">TRANG CHỦ</h1>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">THÔNG BÁO CHO NHÂN VIÊN</h6>
                        </div>
                        <div class="card-body">
                            <p>THÁNG TỚI NGHỈ NHA MẤY ĐỨA</p>
                            <p class="mb-0">Anh nhớ quê nên về vài năm, hẹn ngày tái ngộ ~</p>
                        </div>
                    </div>
                </div>
