...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('lsp.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="idlsp" class="form-label">ID Loại Sản Phẩm:</label>
                            <input type="text" class="form-control form-control-sm" style="width: 500px;" id="idlsp" name="idlsp" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="tenlsp" class="form-label">Tên Loại Sản Phẩm:</label>
                        <input type="text" class="form-control form-control-sm" style="width: 500px;" id="tenlsp" name="tenlsp" required>
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm">Thêm Loại Sản Phẩm</button>
                </form>
            </div>
